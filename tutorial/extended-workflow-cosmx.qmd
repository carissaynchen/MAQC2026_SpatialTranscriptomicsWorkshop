...
The function builds a neighbours list based on polygons with contiguous boundaries, that is sharing one or more boundary point.

boundary points less than snap distance apart are considered to indicate contiguity; used both to find candidate and actual neighbours for planar geometries
...
![Cross L-function diagram. (Courtesy of Valerio Reffo)](cross-l-function-drawing.png)
